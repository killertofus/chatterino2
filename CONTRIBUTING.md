...
requests, issues, comments, and any other contributions to the Chatterino project. Additionally please do not write documentation using AI PR descriptions and commit messages fall under that