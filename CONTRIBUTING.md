...
requests, issues, comments, and any other contributions to the Alacritty project. Additionally please do not write documentation using AI PR descriptions and commit messages fall under that